    ...
    return (
        <div className=" py-3 shadow-md bg-[#8ecae6] top-0 left-0 right-0 fixed">
            ...
            <div className={`${!open && "hidden"} pt-4`}>
                    ...
                    <div className="text-center text-white text-lg hover:bg-orange-400 cursor-pointer py-3 mb-2" href={'https://www.linkedin.com/in/kevinborge/'}>
                        <a href="https://www.linkedin.com/in/kevinborge/" target="blanket">Linkedin</a>
                    </div>
                </div>
            </div>
        </div>
